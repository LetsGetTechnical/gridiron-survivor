...
CI/CD via GitHub Actions all built in. Keeping as many solutions as possible in one place will be
...
- Creating an org, teams, and the repo itself are trivial matters. (And already completed).
  We’re good to go, no further setup needed on the repo itself.

## Risks:

- Depending on the scope of the project, there might some day come a time where we
...
- (L) Engineers will need to stay on top of their assigned issues, moving their tasks
  ...
  clear picture of the project’s status.
