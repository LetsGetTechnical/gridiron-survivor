...
then store those results in our own DB. We can then serve this data to our users. This approach
...
- <a href="https://rapidapi.com/tank01/api/tank01-nfl-live-in-game-real-time-statistics-nfl/">
    Tank01 Live NFL API
  </a>
- A valid option. Consider as a backup.

## Work Required:

- (S) Create API-sports account. May require credit card to account for potential overage
  charges
...
<a href="https://rapidapi.com/api-sports/api/api-american-football/details">
  API-Sports' American Football API Details/Pricing on RapidAPI
</a>
<a href="https://api-sports.io/documentation/nfl/v1">
  API-Sports' American Football API Docs
</a>
