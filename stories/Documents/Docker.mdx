...
- The entire development environment, including OS, libraries, and dependencies, are
  ...
  that contains a full meal, or everything you need to run your application. It can be taken
...
- When setting up Docker in an application, you would make a file known as an image. You can
  think of an image as a list of ingredients needed to make your meal for your lunchbox. The
...
- Setup can be more time-consuming as you have to install everything and make sure all
  software versions are the same.
- It doesn't have the isolation Docker has, meaning the application shares resources with other
  applications.
