...
![screenshot of VS Code search results for 'settings.json' with the User Settings JSON option highlighted](static/media/public/assets/storybook/settingsPrettier.png)
