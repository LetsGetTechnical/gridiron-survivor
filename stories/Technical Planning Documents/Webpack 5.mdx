...
-[Next official documentation on Webpack 5 Adoption](https://nextjs.org/docs/messages/webpack5)

-[Next official documentation on configuring your custom webpack](https://nextjs.org/docs/app/api-reference/next-config-js/webpack)
