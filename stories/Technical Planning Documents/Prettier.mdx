...
# By Ryan Furrer - github: [@ryandotfurrer](https://github.com/ryandotfurrer)
...
[Learn more about Prettier and its use cases.](https://docs.google.com/presentation/d/1WMqDnXBXxwrQnfIKike30pgIrz2eYeocfGc0c3UKPHk/edit?usp=sharing)
...
Prettier gives you options on _when_ to format your code, however, we are going to have it format your code every time you save your project. This will likely cause items to move around the screen, and that’s okay! It is all for the sake of increasing legibility and having a coherent coding style.

## Prettier Config File

A crucial part of our setup is ensuring you do not change any settings and have the `prettier.config.cjs` file at the root of your project. This should be there by default when you clone the project repository. If not, be sure to ask for help in the discord before making up your settings.
...
We want to ignore certain file types and we can do so by creating a `.prettierignore` file at the root of our project.
...
**This is important as you _must_ follow these steps to use Prettier properly within our project.**
