...
# By Mai Vang - github: [@vmaineng](https://github.com/vmaineng) @vmaineng and Jennifer Tieu - github: [@jennifertieu](https://github.com/jennifertieu)
...
An API that allows developers and testers to write test scripts to automate web applications across different browsers, such as Chromium (Chrome), Firefox (Mozilla), and WebKit (Safari)
...
Auto-wait. It waits for elements to be actionable before performing actions.
...
the user’s environment and the planned user experience is correct. End-to-end testing can take
...
possible e2e test would be that the user navigates to the app, logins, views the teams they haven't
picked yet, picks a team before the deadline, and submits.
