...
[Figma Design Example of using Zustand States and local States in the Gridiron Survivor Application](https://www.figma.com/file/U2iFdSq8BkBfBs0Bm5oyXd/State-Management-Detailed-Design?type=whiteboard&node-id=0-1&t=5t5u3cnQbod40HV4-0)

## Next App Zustand Setup

[Github repository example of using Zustand in a Next application](https://github.com/choir27/Next-Zustand-Setup)
...
- [Documentation about the React hook useContext](https://react.dev/reference/react/useContext)

- [React official documentation on Passing Data Deeply with Context](https://react.dev/learn/passing-data-deeply-with-context)
