import '../styles.css';
import testPyramid from '../../public/assets/storybook/testPyramid.png';
import RTLUnit from '../../public/assets/storybook/RTLUnit.png';
import JestUnit from '../../public/assets/storybook/JestUnit.png';
import RTLIntegration from '../../public/assets/storybook/RTLIntegration.png';
import JestIntegration from '../../public/assets/storybook/JestIntegration.png';

import Image from 'next/image';

# React Testing Library vs Jest

# By Mai Vang - github: [@vmaineng](https://github.com/vmaineng)
...
<Image src={testPyramid} alt="Test Pyramid" />
...
<Image src={JestUnit} alt="Code example of Jest Unit Testing" />
...
<Image src={RTLUnit} alt="Code example of RTL Unit Testing" />
...
<Image src={JestIntegration} alt="Code example of Jest Integration Testing" />
...
<Image src={RTLIntegration} alt="Code example of RTL Integration Testing" />
