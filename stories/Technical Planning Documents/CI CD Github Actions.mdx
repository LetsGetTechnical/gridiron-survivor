import '../styles.css';
import githubActions from '../../public/assets/storybook/githubActions.png';
import Image from 'next/image';

# CI CD: GitHub Actions

# By Adam Morsa - github: [@ramblingadam](https://github.com/ramblingadam) and Chris Nowicki - github: [@chris-nowicki](https://github.com/chris-nowicki)
...
<Image src={githubActions} alt="Github Actions Security Cheat Sheet" />
