...
<html>
  <body class="dark bg-background text-muted-foreground max-w-screen-xl mx-auto text-pretty flex flex-col space-y-36 pb-36">
    <header class="header flex justify-center align-middle">
      <a href="https://www.gridironsurvivor.com" target="_blank" rel="noreferrer" class="w-2/6 h-fit">
    ...
    <section class="sponsors-section h-fit">
      <h2 class="pl-16 pb-8">Sponsors</h2>
      <div class="sponsors-card-container flex flex-row flex-wrap justify-between max-w-screen-lg mx-auto">
    ...
    <section class="meet-the-team space-y-12">
      <h2 class="pl-16">Meet the Team</h2>
      <section class="meet-the-team grid grid-cols-4 grid-rows-auto place-items-center mx-auto gap-x-20 gap-y-10 max-w-screen-lg">
